...
<head>
    ...
    <style>
        ...
        .header h1 { margin: 0; font-family: ''Big Shoulders Display'', sans-serif; font-size: 42px; font-weight: 900; letter-spacing: 0.05em; text-transform: uppercase; }
...
<body style="background-color: #f3f4f6; padding: 40px 20px;">
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Thank you for your interest in <span class="highlight">ISKA Student Accommodation</span>!</p>
            ...
            <p style="margin-top: 30px;">Best regards,<br><strong style="color: #3b82f6;">ISKA Team</strong></p>
        </div>
        <div class="footer">
            <div class="footer-logo">ISKA</div>
            <p>&copy; 2026 ISKA Student Accommodation. All rights reserved.</p>
...
<body style="background-color: #f3f4f6; padding: 40px 20px;">
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Welcome to the <strong style="color: #10b981;">ISKA community</strong>! We can''t wait to have you.</p>
            <p style="margin-top: 30px;">Best regards,<br><strong style="color: #10b981;">ISKA Team</strong></p>
        </div>
        <div class="footer">
            <div class="footer-logo">ISKA</div>
            <p>&copy; 2026 ISKA Student Accommodation. All rights reserved.</p>
